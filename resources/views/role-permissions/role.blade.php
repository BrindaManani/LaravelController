                                ...
                                <td class="px-6 py-4 text-end text-sm font-medium">
                                    ...
                                    @if (session('can_delete'))
                                        <button type="submit" id="popup-model"
                                            ...
                                            onclick="document.getElementById('deleteModal-{{ $role['id'] }}').classList.remove('hidden')"><i
                                                class="fa-solid fa-xmark"></i>
                                        </button>

                                        <div id="deleteModal-{{ $role['id'] }}"
                                            ...
                                            <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6 text-left">
                                                ...
                                                <div class="mt-6 flex justify-end gap-3">
                                                    <button type="button"
                                                        ...
                                                        onclick="document.getElementById('deleteModal-{{ $role['id'] }}').classList.add('hidden')">Cancel
                                                    </button>

                                                    <a
                                                        href="{{ route('delete-role', ['id' => $role['id']]) }}">
                                                        <button type="button"
