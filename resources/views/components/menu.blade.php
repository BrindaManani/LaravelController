<div class="border-2 boder-gray-800 bg-white rounded-xl  p-4 w-1/6">
    <ul class="divide-y">
        ...
        <li class="px-3 py-2 rounded hover:text-gray-800 font-medium text-gray-500"><a href="{{ route("re-captcha-settings") }}"
                class="{{ request()->is('*re-captcha-settings') 
                 ? 'text-rose-500' 
                 : 'bg-white text-gray-500 hover:bg-gray-50' }}"><i class="fa-solid fa-shield-halved mr-2"></i>Re-captcha Settings</a></li>
