...
@section('content')
    <form method="post" action="{{ route('user-management-system.register') }}"
        class="mt-10 max-w-xl mx-auto border border-gray-200 rounded-lg p-6 bg-white mt-8 shadow-xl">
        @csrf
        ...
        <div class="grid grid-rows-2">
            ...
            <div class="">
                <label for="name" class="block text-gray-700 font-bold m-3">Password<span class="text-red-500">
                        *</span>
                    <p class="text-sm">(Must contains capital letters, Small letters and numeric value)</p>
                </label>
            ...
            <div class="">
                <label for="name" class="block text-gray-700 font-bold m-3">Confirm Password<span class="text-red-500">
                        *</span>
                    <p class="text-sm">(Must be same as password field)</p>
                </label>
