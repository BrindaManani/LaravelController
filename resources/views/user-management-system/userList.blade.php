...
@section('content')
    ...
    <div class="overflow-x-auto">
        <table class="w-full table-auto bg-white border border-gray-200 rounded-xl shadow-xl">
                ...
                <div class="flex justify-between items-center group">
                    ...
                    <div class="flex items-center space-x-4">
                        <form action="#" method="GET" class="flex items-center m-0">
                            <div class="relative">
                                <input type="text" name="search" class="form-control pr-10 bg-gray-100"
                                    placeholder="Search products..." value="{{ request('search') }}">
                                <button type="submit" class="absolute right-2 top-1/2 -translate-y-1/2 bg-transparent p-0">
                                        ...
                                        <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6 text-left">
                                            ...
                                            <div class="mt-6 flex justify-end gap-3">
                                                ...
                                                <a
                                                    ...
                                                    <button type="button"
                                                        class="rounded-md bg-red-200 px-3 py-2 text-sm font-semibold text-white">delete</button>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
