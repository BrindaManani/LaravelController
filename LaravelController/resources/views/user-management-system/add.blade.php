...
@section('content')
    ...
    <form method="POST" action="{{ route('user-management-system.userCreate') }}" enctype="multipart/form-data"
        ...
        <div class="flex flex-row gap-10 mb-6">
            ...
            <div class="w-1/2 items-start">
                <div class="">
                    <label for="profile[dob]" class="block text-gray-700 font-bold mb-1 pr-4">Date of
        ...
        <div class="flex flex-row gap-4 items-start mb-6">
            <div class="flex-1">
                <span class="block text-gray-700 font-bold mb-4 pr-4">Permissions</span>
            ...
            <div class="flex-1">
                <label for="profile[avatar]" class="block text-gray-700 font-bold mb-1 pr-4">Profile</label>
                <input type="file" name="profile[avatar]" id="profile[avatar]"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
