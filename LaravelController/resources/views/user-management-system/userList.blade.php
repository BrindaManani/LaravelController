...
@section('content')
    ...
    @endif
    <table id="user-list-table" class="mx-auto mt-12 mb-6 border border-gray-200 rounded-lg shadow-xl">
        <thead>
            <tr>
            ...
            @foreach ($users as $user)
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                        ...
                        {{-- <a href="#" onclick="popupBox()">
                            <x-button type="submit" id="popup-model"
                                class="rounded-md bg-linear-to-bl from-red-500 to-orange-200 px-3 py-2 text-sm font-semibold text-white"><i class="fa-solid fa-xmark"></i> Delete</x-button>
                        </a> --}}
                        <button type="submit" id="popup-model"
                                class="rounded-md bg-linear-to-bl from-red-500 to-orange-200 px-3 py-2 text-sm font-semibold text-white" onclick="document.getElementById('deleteModal-{{ $user['id'] }}').classList.remove('hidden')"><i class="fa-solid fa-xmark"></i> Delete
                                             </button>
